...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # => Because (+=) will create a new instance unlike (<<).  Trying .object_id will reveal this.
    # also, (<<) will run faster since it doesn't need to create a new instance each time
  end
