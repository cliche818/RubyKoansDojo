...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #
    # when you need the whole string to match: try something like /^s*/
  end
  ...
  # It finds the first match as seen by the next example.
  ...
  def test_a_character_class_can_be_negated
    #anything inside [^], we ignore in the return value
  ...
  # Alternation requires the specified rule to be more specific than character class
  ...
  def test_sub_is_like_find_and_replace
    # grabbed two out and two[0,1] is t so replace two with t
