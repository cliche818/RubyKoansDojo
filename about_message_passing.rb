...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # send is a very common word and other classes could implement this,
    # this would leave __send__ if people still want to use it
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # All missing methods will go through it.
