...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer the first way as it is obvious which class you are trying to extend with new behaviour
  # The second way is needed if you don't know the class the instance you are using is from
