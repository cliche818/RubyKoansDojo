...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #the param in inject is the inital value for product, so its 1 at the first iteration
    # change it to 2 and result2 = 48 ( 2 * 2 *3 * 4)
    ...
    # a repeat of my other comment, inject puts the first value in the accumulator
    # of the block...
  end
  ...
  #   # code to read 'file'
  #
  #   Doing it the first way, the file will automatically be closed at the end of the block
  #   Second way, requires the file to be closed manually (File.close)
  #
