...
class AboutSymbols < Neo::Koan
  ...
  # ^ there is only 1 of the actual symbol exists, if we do a symbol to string comparison
  # the symbol will be created, thus automatically equal true everytime
  ...
  # ^ Because it is immutable, once made, it will sit in memory until the program exits
  # String is mutable however
end
